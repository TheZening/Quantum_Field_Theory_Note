...
\begin{proof}
  ...
  \begin{align}
    ...
    &= -\frac{\mathrm{i}\,}{\hbar} \hat{H}_{\text{H}}(t) \hat{A}_{\text{H}}(t) + \frac{\mathrm{i}\,}{\hbar} \hat{A}_{\text{H}}(t) \hat{H}_{\text{H}}(t) + \mathrm{i}\,\hbar \hat{U}^\dagger(t,t_0) \pdv{\hat{A}_{\text{S}}(t)}{t} \hat{U}(t,t_0)
  \end{align}
...
当然了, 这个还是形式意义大于实际意义, 因为时间演化算符具体展开出来是非常困难的.
